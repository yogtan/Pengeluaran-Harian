...
public class GuiMenuAwal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lblCariTanggal.setLabelFor(txtPengeluaran);
        ...
        txtCariPengeluaran.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtCariPengeluaranActionPerformed(evt);
            }
        });
    ...
    private void btnInputPengeluaranActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInputPengeluaranActionPerformed
        ...
        pohon.insertNode(new DataPengeluaran(vTanggal, vWaktu, vCatatan, vPengeluaran));
    ...
    private void HapusBtnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_HapusBtnActionPerformed
        int selected = jTabelHapus.getSelectedRow();
        if (selected != -1) {
            List<TreeNode> node = pohon.traverseInOrder();

            if (selected < node.size()) {
                TreeNode selectedNode = node.get(selected);
//                DataPengeluaran selectedPengeluaran = (DataPengeluaran) selectedNode.getData();
                pohon.delete(selected);
                TampilData("Hapus");
...
//            DataPengeluaran cariP = new DataPengeluaran(cari);
            TreeNode hasilPencarian = pohon.search(cari);

            if (hasilPencarian != null) {
                DataPengeluaran dataDitemukan = (DataPengeluaran) hasilPencarian.getData();
                txtHapusCatatan.setText(dataDitemukan.getCatatan());
                txtHapusTanggal.setText(dataDitemukan.getTanggal());
                txtHapusWaktu.setText(dataDitemukan.getWaktu());
                txtHapusPengeluaran.setText(Integer.toString(dataDitemukan.getPengeluaran()));
                JOptionPane.showMessageDialog(this, "Data ditemukan");
            } else {
                txtHapusCatatan.setText("");
...
//            txtHapusPendapatan.setText("");
    ...
    public void TampilDataCari(int i) {
        ...
        txtCariPengeluaran.setText((node.getData().getPengeluaran()));
...
// Metode untuk menampilkan data dalam tabel
    public void TampilData(String jenis) {
        ...
        List<TreeNode> nodeList = pohon.traverseInOrder();
        Object[][] objData = new Object[pohon.size()][4]; // 4 represents the number of columns
        for (int i = 0; i < nodeList.size(); i++) {
            TreeNode node = nodeList.get(i);
            DataPengeluaran data = (DataPengeluaran) node.getData();
            objData[i] = new Object[]{data.getTanggal(), data.getWaktu(), data.getCatatan(), data.getPengeluaran()};
        }
       
         tableModel = new DefaultTableModel(objData, namaKolom) {
            @Override
        ...
        if (jenis.equals("Tampil")) {
            ...
            TableColumnModel columnModel = TabelLaporanHarian1.getColumnModel();
            ...
            TableColumnModel columnModel = jTabelHapus.getColumnModel();
            columnModel.getColumn(0).setPreferredWidth(50);
            columnModel.getColumn(1).setPreferredWidth(200);
            columnModel.getColumn(2).setPreferredWidth(50);
            columnModel.getColumn(3).setPreferredWidth(10);
